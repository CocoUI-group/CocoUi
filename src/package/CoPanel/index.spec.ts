...
describe('CoPanel.vue', () => {
  ...
  describe('can use slot', () => {
    it('header', () => {
      const wrap = mount({
        template: `<CoPanel ><template #header>header</template>Hello World</CoPanel>`,
        components: { CoPanel },
      })
    ...
    it('footer', () => {
      const wrap = mount({
        template: `<CoPanel ><template #footer>footer</template>Hello World</CoPanel>`,
        components: { CoPanel },
      })
    ...
    it('img', () => {
      const wrap = mount({
        template: `<CoPanel ><template #img><img  src='https://hello.world.com' alt=''></template>Hello World</CoPanel>`,
        components: { CoPanel },
      })
  ...
  describe('can set padding', () => {
    it('default md', () => {
      const wrap = mount({
        template: `<CoPanel ><template #header>header</template><template #footer>footer</template>Hello World</CoPanel>`,
        components: { CoPanel },
      })
      const header = wrap.get('div.co-panel__header')
      const content = wrap.get('.co-panel__content')
    ...
    it('set lg', () => {
      const wrap = mount({
        template: `<CoPanel padding='${ThemeSize.lg}'><template #header>header</template><template #footer>footer</template>Hello World</CoPanel>`,
        components: { CoPanel },
      })
      const header = wrap.get('div.co-panel__header')
      const content = wrap.get('.co-panel__content')
